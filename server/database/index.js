...
const savePost = (post) => new Promise((resolve, reject) => {
  ...
  const postInsert = 'INSERT INTO posts(postId, text, img1, title, location, tagList, lumber, metal, concrete, glass, piping, userId, zip) VALUES (DEFAULT, ?)';
  const insertValues = [post.text, post.img1, post.title, post.location, post.tagList, post.lumber, post.metal, post.concrete, post.glass, post.piping, post.userId, post.zip];
